...
echo '
	<div class="wrap">
		...
		<h3 class="nav-tab-wrapper">
			<a class="nav-tab nav-tab-active" href="' . get_bloginfo('wpurl') . '/wp-admin/tools.php?page=cool_tables&action=edit_style&id=' . $this_id . '&settings=basic">Basic Settings</a>
			<a class="nav-tab" href="' . get_bloginfo('wpurl') . '/wp-admin/tools.php?page=cool_tables&action=edit_style&id=' . $this_id . '&settings=advanced">Custom skin colors</a>
		</h3>
		';
					...
					<div id="poststuff">
						<div id="namediv" class="stuffbox">
							...
							<script type="text/javascript">
								...
								<img style="cursor:pointer;" src="' . get_bloginfo('wpurl') . '/wp-content/plugins/cool-tables/images/questionmark.png" onClick="explan_shadow()" title="Adds a shadow around the table. No support in IE8 and lower"><br />
